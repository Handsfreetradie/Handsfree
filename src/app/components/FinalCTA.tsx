      ...
      <div className="max-w-5xl mx-auto px-6 text-center">
        ...
        >
          <h2 className="text-5xl md:text-6xl lg:text-7xl mb-6 text-gray-900">
            Ready to get your
            <br />
            <span className="text-orange-500">custom solution built?</span>
          </h2>
          <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxed">
            Book a call and let's understand your trade. We'll build your setup, go live together, and keep improving it.
          </p>
          ...
          <p className="text-sm text-gray-500 mt-6">
            No lock-in contracts • We're in it with you
          </p>
        </motion.div>
      </div>
    </section>
