  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        "Up to 400 minutes of calls per month",
        "Auto booking direct into your calendar",
        "Business dashboard with analytics",
        "Missed opportunity tracking",
        "Priority support",
        "Custom greetings & call flows",
        "Advanced reporting",
      ],
      cta: "Get Started",
      popular: true,
        ...
        <div className="space-y-4">
          {[
            ...
            },
            {
              ...
              answer: "On Essentials (50 SMS) and Receptionist (200 mins) plans, extra usage is charged at $0.50/min. Pro plan includes 400 minutes. For high-volume needs, our Custom plan offers the best value.",
            },
            {
